...
<div class="setting">
    <div id="nav">
        <a href="../main/mainTwo.html"><img src="assets/img/LogowhiteTitle.png" alt="로고"></a>
        <ul>
            <li><a href="changPw.php">비밀번호 변경</a></li>
            <li><a href="privacyTerms.php">개인 정보 약관</a></li>
            <li class="active"><a href="setting.php">공지 사항</a></li>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if($result){
                                                ...
                                                echo "<tr><th>등록일</th><td class='left'>".date('Y-m-d H시 i분', $info['regTime'])."</td></tr>";
